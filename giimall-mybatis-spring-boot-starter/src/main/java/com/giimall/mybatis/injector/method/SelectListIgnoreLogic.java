 ...
 *
 * @author wangLiuJing
 * @version Id: SelectListIgnoreLogic, v1.0.0 2022年06月23日 10:31 wangLiuJing Exp $ 
 */
public class SelectListIgnoreLogic extends AbstractMethodIgnoreLogic {

	public SelectListIgnoreLogic() {
		super(SqlMethodIgnoreLogic.SELECT_LIST_IGNORE_LOGIC);
	}
